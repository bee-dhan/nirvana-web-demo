...
const products = [
	{
		...
		brand: "Modern Basics",
		description:
			"A lightweight and breathable cotton t-shirt perfect for everyday wear.",
		image:
			"https://images.unsplash.com/photo-1602810317283-957c9fd944f1?auto=format&fit=crop&w=500&q=80",
		price: 19.99,
		colors: [
			{
				name: "White",
				class: "bg-white",
				image:
					"https://images.unsplash.com/photo-1585386959984-a41552261f5c?auto=format&fit=crop&w=500&q=80",
			},
			{
				name: "Black",
				class: "bg-black",
				image:
					"https://images.unsplash.com/photo-1578685720588-1b462a4b0156?auto=format&fit=crop&w=500&q=80",
			},
		],
		isNewArrival: true,
		bestseller: false,
	...
	},
	{
		...
		brand: "GreenFit",
		description:
			"Eco-friendly joggers made with recycled materials. Slim fit and stretchable.",
		image:
			"https://images.unsplash.com/photo-1618354691373-9d91e9ac3b0c?auto=format&fit=crop&w=500&q=80",
		price: 39.99,
		colors: [
			{
				name: "Olive",
				class: "bg-green-700",
				image:
					"https://images.unsplash.com/photo-1627322413465-412ff3b3b253?auto=format&fit=crop&w=500&q=80",
			},
			{
				name: "Gray",
				class: "bg-gray-400",
	...
	},
	{
		...
		brand: "Urban Pack",
		description:
			"Durable and stylish backpack for urban commuting and weekend getaways.",
		image:
			"https://images.unsplash.com/photo-1518546305927-5f7160d4dfaf?auto=format&fit=crop&w=500&q=80",
		price: 59.95,
		colors: [
			{
				name: "Beige",
			...
			},
			{
				...
				class: "bg-gray-800",
				image:
					"https://images.unsplash.com/photo-1592503254549-29f04a78c1f5?auto=format&fit=crop&w=500&q=80",
			},
		],
		isNewArrival: true,
		bestseller: true,
...
function CollectionPage() {
	...
	return (
		<div className="p-6 space-y-8">
			...
			{/* Hero Section */}
			<section
				className="relative w-full h-[300px] bg-cover bg-center rounded-xl shadow"
				style={{
